...
>({
  ...
  createInstance(
    ...
    // @ts-expect-error the instance is created in a later phase
  ): Instance {
    log.debug("createInstance");
  },

  appendInitialChild(_parentInstance: Instance, _child: Instance | TextInstance): void {
  ...
  appendChildToContainer(_container: Container, _child: Instance | TextInstance): void {
    log.debug("appendChildToContainer");
  },

  appendChild(_parentInstance: Instance, _child: Instance | TextInstance): void {
